...
python tools/test.py  configs/carafe/coco_mask_r101_carafe2.py  work_dirs/coco_mask_r101_carafe2/latest.pth  --format-only --options "jsonfile_prefix=./coco_test_result/detections_test-dev2017_mask-r101-2x-cf2_results"
