...
python tools/test.py  configs/carafe/coco_mask_r50.py  work_dirs/coco_mask_r50/latest.pth  --format-only --options "jsonfile_prefix=./coco_test_result/detections_test-dev2017_mask-r50-1x_results"
