...
python tools/test.py  configs/carafe/coco_carafe2.py  work_dirs/coco_carafe2/latest.pth  --format-only --options "jsonfile_prefix=./coco_test_result/det_faster_cf2"
