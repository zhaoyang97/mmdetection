...
python tools/test.py  configs/carafe/coco_carafe.py  work_dirs/coco_carafe/latest.pth  --format-only --options "jsonfile_prefix=./coco_test_result/det_faster_cf"
