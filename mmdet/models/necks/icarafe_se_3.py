...
# modified by zy 20210315
class CARAFE_se_3(nn.Module):
    def __init__(self, channels, compressed_channels=64, scale_factor=2, up_kernel=5, encoder_kernel=3):
        ...
        """
        super(CARAFE_se_3, self).__init__()
        ...
        # c = 100
        self.se = SqueezeExcitation_c100(compressed_channels)
