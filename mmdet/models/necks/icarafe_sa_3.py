...
class CARAFE_sa_3(nn.Module):
    def __init__(self, channels, compressed_channels=64, scale_factor=2, up_kernel=5, encoder_kernel=3):
        ...
        """
        super(CARAFE_sa_3, self).__init__()
        ...
        self.sapatialAttention = SpatialAttention()
    ...
    def forward(self, X):
        ...
        # modified by zy 20210316W
        W = self.sapatialAttention(W) * W
        W_ = W
