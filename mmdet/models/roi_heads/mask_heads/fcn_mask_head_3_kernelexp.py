...
from ...carafe.icarafe_3_kernelexp import CARAFE_3_kernelexp as CARAFEPack
...
class FCNMaskHead_3_kernelexp(nn.Module):
    ...
    def __init__(self,
        ...
        super(FCNMaskHead_3_kernelexp, self).__init__()
        ...
        if self.upsample_method is None:
            ...
            self.upsample = build_upsample_layer(upsample_cfg_)
            # self.upsample = CARAFEPack(upsample_in_channels, scale_factor=2)
        else:
            # suppress warnings
            align_corners = (None
