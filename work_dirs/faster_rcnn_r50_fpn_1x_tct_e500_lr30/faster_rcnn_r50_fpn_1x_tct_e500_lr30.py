model = dict(
    type='FasterRCNN',
    pretrained='../mmclassification/work_dirs/tct_resnet50_b32x8/epoch_500.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
optimizer = dict(
    type='SGD', lr=0.0003333333333333333, momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/faster_rcnn_r50_fpn_1x_tct_e500_lr30/epoch_10.pth'
workflow = [('train', 1)]
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_tct_e500_lr30'
gpu_ids = range(0, 4)
