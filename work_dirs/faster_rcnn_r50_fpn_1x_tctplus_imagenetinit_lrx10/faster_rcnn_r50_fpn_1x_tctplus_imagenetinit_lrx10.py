model = dict(
    type='FasterRCNN',
    pretrained=
    '../mmclassification/work_dirs/tctplus_resnet50_b32x8_imagenet/epoch_100_pretrained.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/faster_rcnn_r50_fpn_1x_tctplus_imagenetinit_lrx10/epoch_4.pth'
workflow = [('train', 1)]
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_tctplus_imagenetinit_lrx10'
gpu_ids = range(0, 4)
