model = dict(
    type='FasterRCNN',
    pretrained=
    '../mmclassification/work_dirs/tct_full_resnet50_b32x8/epoch_100_pretrained.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/tct_full_e100_lrx3/epoch_3.pth'
workflow = [('train', 1)]
work_dir = './work_dirs/tct_full_e100_lrx3'
gpu_ids = range(0, 4)
